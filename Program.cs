...
namespace Practica1_CalafatSerranoAlejandro_GarciaBaenaJulianManuel
{
    ...
    class Program
    {
        ...
        static void ApartadoA()
        {
            ...
            vectorResultado.LeerVector(ref vector1);
            vectorResultado.LeerVector(ref vector2);
        ...
        private static void ApartadoC() {
            ...
            double[] resultado1 = vec2DP.LeerVector(ref vector1);
            double[] resultado2 = vec2DP.LeerVector(ref vector2);
